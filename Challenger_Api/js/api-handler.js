...
const RequestWrapper = async (url, options = {}) => {
  ...
  try {
    ...
    if (typeof result !== "object") {
      throw new Error("NotValidJSONFormatException");
    }
    return result;
  } catch (error) {
    console.error(error);
...
const ApiClientJobs = () => {
   ...
   */
  const getJobSkillByJobId = (id) =>
    RequestWrapper(JOB_URL + "/" + id + "/related_skills");
   ...
   * @returns {Promise<Array<Job>>}
   */
  const getJobRelatedByJobId = (id) =>
    RequestWrapper(JOB_URL + "/" + id + "/related_jobs");
   ...
   * @param {string} contains search for string that contains...
  ...
  return {
    ...
    getJobById,
    getJobSkillByJobId,
    getJobRelatedByJobId,
    getJobAutocompletion,
    getJobNormalizer,
    getJobUnusualTitles,
    getAllSkills,
    getSkillById,
    getSkillRelatedJobBySkillId,
    getSkillRelatedSkillBySkillId,
    getSkillAutocompletion,
    getSkillNormalizer,
  };
};
